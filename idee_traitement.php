...
if (
    ...
    $data->setIdee($idee);
    $data->addIdee();
    $_SESSION['flash_idee'] = 'Idée soumise';
                                                            ...
                                                            <td align=\'left\'>
                                                                <div class="contentEditableContainer contentTextEditable">
                                                                    <div class="contentEditable" align=\'center\'>
                                                                        <h2>Réception d\'email - Boite à idée </h2>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <div class="contentEditableContainer contentTextEditable">
                                                                    <div class="contentEditable" align=\'center\'>
                                                                        <p>
                                                                            ...
                                                                            la récéption de votre idée. Si celle ci est choisit
                                                                            ...
                                                                            nous reviendrons vers vous, dans le cas échéant ne baissé pas les
                                                                            bras.
...
';
    $headers = "From: \"expediteur moi\"<contact@yuna-creation.fr.3>\n";
    $headers .= "Reply-To: contact@yuna-creation.fr\n";
    $headers .= "Content-Type: text/html; charset=\"iso-8859-1\"";

    mail($mail,'test message',$message,$headers);
